...
class TestCalculateChunkBoundaries:
    ...
    def test_basic_chunking_with_overlap(self):
        ...
        result = calculate_chunk_boundaries(10.0, 3.0, 0.5, 25)
    ...
    def test_chunking_without_overlap(self):
        ...
        result = calculate_chunk_boundaries(5.0, 2.0, 0.0, 25)
    ...
    def test_single_chunk_when_duration_less_than_chunk_duration(self):
        ...
        result = calculate_chunk_boundaries(3.0, 5.0, 1.0, 25)
        expected = [(0.0, 3.0)]
        actual_boundaries = boundaries_to_tuples(result)
        assert actual_boundaries == expected
    ...
    def test_exact_multiple_chunks(self):
        ...
        result = calculate_chunk_boundaries(6.0, 2.0, 0.5, 25)
    ...
    def test_fractional_duration(self):
        ...
        result = calculate_chunk_boundaries(7.5, 2.0, 0.25, 25)
    ...
    def test_fractional_chunk_duration(self):
        ...
        result = calculate_chunk_boundaries(5.0, 1.5, 0.25, 25)
    ...
    def test_zero_duration(self):
        ...
        result = calculate_chunk_boundaries(0.0, 2.0, 0.5, 25)
        expected = []
        actual_boundaries = boundaries_to_tuples(result)
        assert actual_boundaries == expected
    ...
    def test_very_small_duration(self):
        ...
        result = calculate_chunk_boundaries(0.1, 1.0, 0.05, 25)
        expected = [(0.0, 0.1)]
        actual_boundaries = boundaries_to_tuples(result)
        assert actual_boundaries == expected
    ...
    def test_large_overlap(self):
        ...
        result = calculate_chunk_boundaries(10.0, 4.0, 2.0, 25)
    ...
    def test_minimal_overlap(self):
        ...
        result = calculate_chunk_boundaries(6.0, 2.0, 0.001, 25)
...
class TestCalculateChunkBoundariesErrors:
    ...
    def test_negative_duration(self):
        ...
        with pytest.raises(ValueError, match="Duration must be non-negative"):
            calculate_chunk_boundaries(-1.0, 2.0, 0.5, 25)
...
class TestCalculateChunkBoundariesEdgeCases:
    ...
    def test_floating_point_precision(self):
        ...
        result = calculate_chunk_boundaries(1.0, 0.3333333333333333, 0.1, 25)
    ...
    def test_very_large_numbers(self):
        ...
        result = calculate_chunk_boundaries(1000000.0, 1000.0, 100.0, 25)
    ...
    def test_chunk_boundaries_are_ordered(self):
        ...
        result = calculate_chunk_boundaries(10.0, 2.0, 0.5, 25)
        actual_boundaries = boundaries_to_tuples(result)
